    ...
    <div class="fluid-container">
      ...
      <div class="heading-section"><!-- Headin Section Start -->
        <div class="col-lg-offset-2 col-lg-8 col-md-offset-1 col-md-10 col-sm-12">
          ...
          <div class="row">
            ...
            <div class="col-lg-offset-2 col-lg-8 col-md-offset-2 col-md-8 col-sm-offset-2 col-sm-8 col-xs-12 text-center">
              <h1>Log <span class="green">In</span></h1>
        ...
        <form name="logIn" method="post" action="loginHandler.php">
          ...
          <div class="row form-group">
            <div class="col-xs-offset-1"><label for="email">Email</label></div>
            <div class="col-xs-offset-1 col-xs-10"><input type="Email" class="form-control" id="email" placeholder="johnsmith@example.ie"></div>
          </div>

          <div class="row form-group">
            <div class="col-xs-offset-1"><label for="password">Password</label></div>
            <div class="col-xs-offset-1 col-xs-10"><input type="password" class="form-control" id="password" placeholder="Password"></div>
          </div>

          <div class="row form-group">
            <div class="col-xs-offset-5 col-xs-1"><a href="dashboard.php"><button id="logInSubmit" type="submit" class="btn btn-primary" >Submit</button></a></div>
          </div>
